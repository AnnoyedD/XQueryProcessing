...
public class XMLTreefunction {
	...
	public static ArrayList<Node> getDescendant(Node subRoot){return null;}
	
	public static String attrib(Node n, String attName){return null;} //unsure about the return type
			
	public static ArrayList<Node> unique(ArrayList<Node> list){return null;}
