...
public class XQueryBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements XQueryVisitor<T> {
	 ...
	 * {@link #visitChildren} on {@code ctx}.</p>
	 */
	@Override public T visitRpSlashSlash(@NotNull XQueryParser.RpSlashSlashContext ctx) { return visitChildren(ctx); }
	 ...
	 * {@link #visitChildren} on {@code ctx}.</p>
	 */
	@Override public T visitAp(@NotNull XQueryParser.ApContext ctx) { return visitChildren(ctx); }
